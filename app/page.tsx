				...
				<section className="bg-brown-50 py-16 md:py-32">
					...
					>
						...
						<p className="text-center mb-12 max-w-2xl mx-auto">
							An app that helps us learn and remember the life of Prophet Muhammad ﷺ through simple, structured,
							bite-sized, and engaging chapters — guided knowledge you can apply in your everyday lives.
						</p>
				...
				<section className="bg-white py-16 md:py-32">
					...
					>
						<div className="flex flex-col items-center gap-8">
							...
							<p className="mb-2">I'm Kamilah, the founder of The Seerah App ✨</p>
							<p className="mb-2">
								We're on a mission to make learning about the life of Prophet Muhammad ﷺ both easy and memorable through
								a beautifully designed, user-friendly tool.
							</p>
							<p className="mb-2">
								But I'm not building this alone – I want you to be part of the journey with me! Think of yourselves as
								apart of The Seerah App team, shaping this project for the Ummah, by the Ummah. 🤝 Your ideas and
								feedback mean the world to us, and together, we can create something truly impactful.
							</p>
							<p className="mb-2">
								Let's build something meaningful and earn ongoing rewards, insha'Allah. Have thoughts, suggestions or
								want to get involved? Please reach out – I'd love to hear from you!
							</p>
						</div>
					</motion.div>
				</section>
